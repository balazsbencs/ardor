...
//=============================================================================
// Ported from terrarium-poly-octave/util/Multirate.h.
// ring_buffer uses std::array storage to avoid heap allocation.
class Decimator
{
public:
...
private:
    ...
    {
        // Half-band filter
        // 16000 Hz sample rate, 0-1800 Hz pass band
        return
    ...
    cycfi::q::ring_buffer<float, std::array<float, bsize1>> buffer1;
    cycfi::q::ring_buffer<float, std::array<float, bsize2>> buffer2;
};
...
private:
    // Filter 1 — 16000 Hz SR, 0-3600 Hz pass, 4400-8000 Hz stop, gain=2
    float filter1a()
    {
        return
    ...
    // Filter 2 — 48000 Hz SR, 0-3600 Hz pass, 8000-24000 Hz stop, gain=3
    float filter2a()
    {
        return
