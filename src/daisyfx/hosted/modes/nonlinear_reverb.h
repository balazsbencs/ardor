...
private:
    ...
    float          buf_diff_l0_[pedal::diffuser_delays::NONLINEAR_L[0] + Diffuser::MOD_HEADROOM];
    float          buf_diff_l1_[pedal::diffuser_delays::NONLINEAR_L[1] + Diffuser::MOD_HEADROOM];
    float          buf_diff_l2_[pedal::diffuser_delays::NONLINEAR_L[2] + Diffuser::MOD_HEADROOM];
    float          buf_diff_l3_[pedal::diffuser_delays::NONLINEAR_L[3] + Diffuser::MOD_HEADROOM];
    float          buf_diff_r0_[pedal::diffuser_delays::NONLINEAR_R[0] + Diffuser::MOD_HEADROOM];
    float          buf_diff_r1_[pedal::diffuser_delays::NONLINEAR_R[1] + Diffuser::MOD_HEADROOM];
    float          buf_diff_r2_[pedal::diffuser_delays::NONLINEAR_R[2] + Diffuser::MOD_HEADROOM];
    float          buf_diff_r3_[pedal::diffuser_delays::NONLINEAR_R[3] + Diffuser::MOD_HEADROOM];
