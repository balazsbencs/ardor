...
private:
    ...
    float buf_diff_l0_[pedal::diffuser_delays::BLOOM_L[0] + Diffuser::MOD_HEADROOM];
    float buf_diff_l1_[pedal::diffuser_delays::BLOOM_L[1] + Diffuser::MOD_HEADROOM];
    float buf_diff_l2_[pedal::diffuser_delays::BLOOM_L[2] + Diffuser::MOD_HEADROOM];
    float buf_diff_l3_[pedal::diffuser_delays::BLOOM_L[3] + Diffuser::MOD_HEADROOM];
    float buf_diff_r0_[pedal::diffuser_delays::BLOOM_R[0] + Diffuser::MOD_HEADROOM];
    float buf_diff_r1_[pedal::diffuser_delays::BLOOM_R[1] + Diffuser::MOD_HEADROOM];
    float buf_diff_r2_[pedal::diffuser_delays::BLOOM_R[2] + Diffuser::MOD_HEADROOM];
    float buf_diff_r3_[pedal::diffuser_delays::BLOOM_R[3] + Diffuser::MOD_HEADROOM];
    float buf_fdn0_[2904];
    float buf_fdn1_[3492];
    float buf_fdn2_[4160];
    float buf_fdn3_[4814];
    float buf_fdn4_[3166];
    float buf_fdn5_[3802];
    float buf_fdn6_[4486];
    float buf_fdn7_[5186];
};
