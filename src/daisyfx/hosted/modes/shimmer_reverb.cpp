...
void ShimmerReverb::Init() {
    ...
    diffuser_l_.Init(diff_bufs_l, diff_sizes_l, diffuser_delays::SHIMMER_L);
    diffuser_r_.Init(diff_bufs_r, diff_sizes_r, diffuser_delays::SHIMMER_R);
    ...
    diffuser_l_.SetModulationRate(0.1300f, REVERB_SAMPLE_RATE);
    diffuser_l_.SetModulation(2.5f);
    diffuser_r_.SetModulationRate(0.1521f, REVERB_SAMPLE_RATE);
