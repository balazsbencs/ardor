Ardor Daisy FX hosted engine — origin record
=============================================

Source: `/Users/bbalazs/daisy/multi-fx`
Import date: 2026-07-10

This folder began as a portable subset of the Daisy multi-fx source and is now
an Ardor-maintained effect engine. Ardor owns its runtime integration and may
modify its implementation. The upstream origin and MIT license are preserved
in `UPSTREAM_LICENSE`.
